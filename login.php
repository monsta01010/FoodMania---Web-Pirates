...
<head>
    <meta charset="UTF-8">
    <title>Login || Easy Ordering & Complete Restaurant Guide - Web Pirates</title>
        ...
        <div class="col-sm-5 authfy-panel-left">
          <div class="brand-col">
            <div class="headline">
              ...
              <h2 style=" color: white; font-weigth:650; line-heigth:1.25">Team Web Pirates</h2>
          ...
          <div class="authfy-login">
            ...
            <div class="authfy-panel panel-login text-center active">
              <div class="authfy-heading">
                ...
                <p>Don’t have an account? <a class="lnk-toggler" data-panel=".panel-signup" href="registration.php">Sign Up Free!</a></p>
              </div>
              <div class="row">
                <div class="col-xs-12 col-sm-12">
                  <form class="loginForm" action="" method="post">
                    ...
                    <div class="form-group">
                      <input class="btn btn-lg btn-primary btn-block" type="submit" id="buttn" name="submit" value="Login">
