                ...
                <body class="fix-header fix-sidebar">
                    ...
                    <div id="main-wrapper">
                        ...
                        <div class="page-wrapper">
                            ...
                            <marquee onMouseOver="this.stop()" onMouseOut="this.start()">This website is build by Team Web Pirates for HACKNITA 2024. MD5 Encryption Technology is used to make it Password protected.   </marquee>
                            </div>
                    ...
                    <footer class="footer">Copyright © 2024 - Web-Pirates - HACKNITA 2024</footer>
