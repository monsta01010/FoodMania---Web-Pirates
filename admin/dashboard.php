...
<body class="fix-header" >
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="./images/food-mania.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
        ...
        <div class="page-wrapper" style="background:url(images/pancakes.jpg);">

            
            <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()">This website is build by Team Web Pirates for HACKNITA 2024. MD5 Encryption Technology is used to make this website Password protected.   </marquee>
            </div>
