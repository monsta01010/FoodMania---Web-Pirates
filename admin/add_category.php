    ...
    <div id="main-wrapper" >
        ...
        <div class="page-wrapper" style="background:url(images/pancakes.jpg);">
            <div style="padding-top: 10px;">
                <marquee onMouseOver="this.stop()" onMouseOut="this.start()"> <a href=""></a>This website is build by Team Web Pirates for HACKNITA 2024. MD5 Encryption Technology is used to make it Password protected.   </marquee>
            </div>
